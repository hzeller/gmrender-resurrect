...
static const char *product_default_values[] = {
	...
	[PRODUCT_VAR_ATTRIBUTES] = "Info Time Volume",
...
static struct var_meta product_var_meta[] = {
	[PRODUCT_VAR_MANUFACTURER_NAME] =       { "ManufacturerName", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_MANUFACTURER_INFO] =       { "ManufacturerInfo", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_MANUFACTURER_URL] =        { "ManufacturerUrl", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_MANUFACTURER_IMAGE_URL] =  { "ManufacturerImageUrl", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_MODEL_NAME] =              { "ModelName", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_MODEL_INFO] =              { "ModelInfo", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_MODEL_URL] =               { "ModelUrl", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_MODEL_IMAGE_URL] =         { "ModelImageUrl", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_PRODUCT_ROOM] =            { "ProductRoom", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_PRODUCT_NAME] =            { "ProductName", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_PRODUCT_INFO] =            { "ProductInfo", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_PRODUCT_URL] =             { "ProductUrl", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_PRODUCT_IMAGE_URL] =       { "ProductImageUrl", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_STANDBY] =                 { "Standby", SENDEVENT_YES, DATATYPE_BOOLEAN, NULL, NULL },
	[PRODUCT_VAR_SOURCE_INDEX] =            { "SourceIndex", SENDEVENT_YES, DATATYPE_UI4,     NULL, NULL },
	[PRODUCT_VAR_SOURCE_COUNT] =            { "SourceCount", SENDEVENT_YES, DATATYPE_UI4,     NULL, NULL },
	[PRODUCT_VAR_SOURCE_XML] =              { "SourceXml", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_ATTRIBUTES] =              { "Attributes", SENDEVENT_YES, DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_SOURCE_XML_CHANGE_COUNT] = { "SourceXmlChangeCount", SENDEVENT_NO,  DATATYPE_UI4,     NULL, NULL },
	[PRODUCT_VAR_SOURCE_TYPE] =             { "SourceType", SENDEVENT_NO,  DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_SOURCE_NAME] =             { "SourceName", SENDEVENT_NO,  DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_SOURCE_VISIBLE] =          { "SourceVisible", SENDEVENT_NO,  DATATYPE_STRING,  NULL, NULL },
	[PRODUCT_VAR_UNKNOWN] =                 { NULL, SENDEVENT_NO,  DATATYPE_UNKNOWN, NULL, NULL },
};
