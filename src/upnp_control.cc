...
struct service *upnp_control_get_service(void) {
  ...
  static struct var_meta control_var_meta[] = {
      ...
      {CONTROL_VAR_BRIGHTNESS, "Brightness", "0", EV_NO, DataType::kUint2, NULL,
       &brightness_range},
      {CONTROL_VAR_CONTRAST, "Contrast", "0", EV_NO, DataType::kUint2, NULL,
       &contrast_range},
      {CONTROL_VAR_SHARPNESS, "Sharpness", "0", EV_NO, DataType::kUint2, NULL,
       &sharpness_range},
      {CONTROL_VAR_R_GAIN, "RedVideoGain", "0", EV_NO, DataType::kUint2, NULL,
       &vid_gain_range},
      {CONTROL_VAR_G_GAIN, "GreenVideoGain", "0", EV_NO, DataType::kUint2, NULL,
       &vid_gain_range},
      {CONTROL_VAR_B_GAIN, "BlueVideoGain", "0", EV_NO, DataType::kUint2, NULL,
       &vid_gain_range},
      {CONTROL_VAR_R_BLACK, "RedVideoBlackLevel", "0", EV_NO, DataType::kUint2,
       NULL, &vid_black_range},
      {CONTROL_VAR_G_BLACK, "GreenVideoBlackLevel", "0", EV_NO, DataType::kUint2,
       NULL, &vid_black_range},
      {CONTROL_VAR_B_BLACK, "BlueVideoBlackLevel", "0", EV_NO, DataType::kUint2,
       NULL, &vid_black_range},
      {CONTROL_VAR_COLOR_TEMP, "ColorTemperature", "0", EV_NO, DataType::kUint2,
       NULL, &colortemp_range},
      {CONTROL_VAR_HOR_KEYSTONE, "HorizontalKeystone", "0", EV_NO, DataType::kInt2,
       NULL, &keystone_range},
      {CONTROL_VAR_VER_KEYSTONE, "VerticalKeystone", "0", EV_NO, DataType::kInt2,
       NULL, &keystone_range},
      {CONTROL_VAR_MUTE, "Mute", "0", EV_NO, DataType::kBoolean, NULL, NULL},
      {CONTROL_VAR_VOLUME, "Volume", "0", EV_NO, DataType::kUint2, NULL,
       &volume_range},
      {CONTROL_VAR_VOLUME_DB, "VolumeDB", "0", EV_NO, DataType::kInt2, NULL,
       &volume_db_range},
      {CONTROL_VAR_LOUDNESS, "Loudness", "0", EV_NO, DataType::kBoolean, NULL,
       NULL},

      {CONTROL_VAR_COUNT, NULL, NULL, EV_NO, DataType::kUnknown, NULL, NULL}};
