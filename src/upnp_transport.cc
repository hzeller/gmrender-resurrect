...
struct service *upnp_transport_get_service(void) {
  ...
  static struct var_meta transport_var_meta[] = {
      ...
      {TRANSPORT_VAR_REC_MEDIUM_WR_STATUS, "RecordMediumWriteStatus",
       "NOT_IMPLEMENTED", EV_NO, DataType::kString, rec_write_stati, NULL},
      {TRANSPORT_VAR_CUR_REC_QUAL_MODE, "CurrentRecordQualityMode",
       "NOT_IMPLEMENTED", EV_NO, DataType::kString, rec_quality_modi, NULL},
      {TRANSPORT_VAR_POS_REC_QUAL_MODE, "PossibleRecordQualityModes",
       "NOT_IMPLEMENTED", EV_NO, DataType::kString, NULL, NULL},
      {TRANSPORT_VAR_NR_TRACKS, "NumberOfTracks", "0", EV_NO, DataType::kUint4,
       NULL, &track_nr_range}, /* no step */
      {TRANSPORT_VAR_CUR_TRACK, "CurrentTrack", "0", EV_NO, DataType::kUint4, NULL,
       &track_range},
      ...
      {TRANSPORT_VAR_CUR_TRACK_URI, "CurrentTrackURI", "", EV_NO,
       DataType::kString, NULL, NULL},
      {TRANSPORT_VAR_AV_URI, "AVTransportURI", "", EV_NO, DataType::kString, NULL,
       NULL},
      ...
      {TRANSPORT_VAR_REL_CTR_POS, "RelativeCounterPosition", "2147483647",
       EV_NO, DataType::kInt4, NULL, NULL},
      ...
      {TRANSPORT_VAR_COUNT, NULL, NULL, EV_NO, DataType::kUnknown, NULL, NULL}};
